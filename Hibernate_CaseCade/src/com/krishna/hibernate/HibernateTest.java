...
public class HibernateTest {
	...
	public static void main(String[] args) {
		...
		usd.setUserName("Hare Krishna Hare krishna Krishna Krishna Hare Hare 1 ");
		...
		session.persist(usd);// if we are using casecade then we have to use persist insted of save 
//		session.save(veh);
//		session.save(veh1);
